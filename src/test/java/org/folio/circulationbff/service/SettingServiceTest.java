...
//  void isEcsTlrSettingsEnabledTest(boolean isCentralTenant, TlrSettings tlrSettings, boolean expectedValue) {
//
...
//
//    assertThat(service.isEcsTlrFeatureEnabled(isCentralTenant), equalTo(expectedValue));
//  }
//
...
//    return Stream.of(
//      Arguments.of(true, buildTlrSettings(true),  true),
//      Arguments.of(true, buildTlrSettings(false),  false)
